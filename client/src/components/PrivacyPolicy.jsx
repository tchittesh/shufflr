    ...
    return (
      <div>
        ...
        <p>
          ...
          {' '}
          <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" rel="noreferrer">Privacy Policy Generator</a>
          .
        </p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              {' '}
              (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Shufflr.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              {' '}
              refers to Shufflr, accessible from
              {' '}
              <a href="http://shufflr.org" rel="external nofollow noopener noreferrer" target="_blank">http://shufflr.org</a>
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          ...
          {' '}
          <a href="https://www.freeprivacypolicy.com/blog/cookies/" target="_blank" rel="noreferrer">Cookies: What Do They Do?</a>
          .
        </p>
        ...
        <ul>
          <li>By email: shufflr.app@gmail.com</li>
        </ul>
      </div>
    );
  }
